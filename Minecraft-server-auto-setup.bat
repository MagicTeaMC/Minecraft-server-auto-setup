...
cls
echo:
echo       開始下載 BungeeCord (MC version 1.20.X)
...
cls
echo:
echo       BungeeCord (MC version 1.20.X) 下載完成
...
cls
echo:
echo       開始下載 Waterfall (MC version 1.20.X)
...
echo:
echo:
echo       Waterfall (MC version 1.20.X) 下載完成
echo java -Xmx512M -Xms124M -jar server.jar nogui> StartServer.bat
goto bungeengrok
...
cls
echo:
echo       開始下載 Velocity (MC version 1.20.X)
