...
cls
echo:
echo       開始下載 Folia (MC version 1.20)
...
echo:
echo:
echo       Folia (MC version 1.20) 下載完成
echo java -Xmx4096M -Xms1024M -jar server.jar nogui> StartServer.bat
goto ngrok
...
cls
echo:
echo       開始下載 BungeeCord (MC version 1.20)
...
cls
echo:
echo       BungeeCord (MC version 1.20) 下載完成
...
cls
echo:
echo       開始下載 Waterfall (MC version 1.20)
